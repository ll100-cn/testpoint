...
export const standard = {
  root: bva('', {}),
  content: bva(`
    relative z-50 max-h-96 min-w-32 overflow-hidden rounded-md border bg-popover-background text-popover-foreground shadow-md
  ...
  trigger: bva(`
    flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input-background bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background
