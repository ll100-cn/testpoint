<template>
  <DatePicker :input-id="controlId" unstyled :pt="pt" v-model="modelValue" date-format="yy-mm-dd" show-time show-icon select-other-months show-button-bar icon-display="input" />
</template>
