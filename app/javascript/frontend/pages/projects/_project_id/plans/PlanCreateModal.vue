      ...
      <div class="modal-content">
        ...
        <form @submit="onSubmit">
          <div class="modal-body">
            ...
            <component :is="layouts.vertical_group" v-slot="slotProps" :validation="validations.disconnect('platform_id')" label="平台">
              <component :is="forms.select" v-bind="{ ...slotProps, form, collection: platforms, labelMethod: 'name', valueMethod: 'id' }" />
            </component>
          </div>
