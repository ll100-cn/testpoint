<template>
  <div class="mx-3 space-y-3">
    ...
    <div class="treeview block-archived" v-if="tree.archived.length > 0">
      <h5 class="text-lg">归档</h5>
      <ul>
    ...
    <div class="treeview block-archived" v-if="tree.ignored.length > 0">
      <h5 class="text-lg">忽略</h5>
      <ul>
