      ...
      <div class="modal-content">
        ...
        <FormHorizontal :validations="validations" @submit="submitForm">
          <div class="modal-body">
            ...
            <component :is="layouts.group" :validation="validations.disconnect('role_name')" label="角色" :disableds="form_disabled_mapping">
            ...
            <component :is="layouts.group" :validation="validations.disconnect('scene_name')" label="场景" :disableds="form_disabled_mapping">
              <template #label-prepend="{ code }">
                <div class="form-check col-auto form-switch">
                  <input v-model="form_enabled_mapping[code]" class="form-check-input" type="checkbox" role="switch">
                </div>
            ...
            <component :is="layouts.group" :validation="validations.disconnect('group_name')" label="分组" :disableds="form_disabled_mapping">
              <template #label-prepend="{ code }">
                <div class="form-check col-auto form-switch">
                  <input v-model="form_enabled_mapping[code]" class="form-check-input" type="checkbox" role="switch">
                </div>
            ...
            <component :is="layouts.group" :validation="validations.disconnect('title')" label="标题" :disableds="form_disabled_mapping">
              <template #label-prepend="{ code }">
                <div class="form-check col-auto form-switch">
                  <input v-model="form_enabled_mapping[code]" class="form-check-input" type="checkbox" role="switch">
                </div>
            ...
            <component :is="layouts.group" :validation="validations.disconnect('content')" label="内容" :disableds="form_disabled_mapping">
              <template #label-prepend="{ code }">
                <div class="form-check col-auto form-switch">
                  <input v-model="form_enabled_mapping[code]" class="form-check-input" type="checkbox" role="switch">
                </div>
            ...
            <component :is="layouts.group" :validation="validations.disconnect('platform_ids')" label="平台" :disableds="form_disabled_mapping">
              <template #label-prepend="{ code }">
                <div class="form-check col-auto form-switch">
                  <input v-model="form_enabled_mapping[code]" class="form-check-input" type="checkbox" role="switch">
                </div>
            ...
            <component :is="layouts.group" :validation="validations.disconnect('label_ids')" label="标签" :disableds="form_disabled_mapping">
              <template #label-prepend="{ code }">
                <div class="form-check col-auto form-switch">
                  <input v-model="form_enabled_mapping[code]" class="form-check-input" type="checkbox" role="switch">
                </div>
