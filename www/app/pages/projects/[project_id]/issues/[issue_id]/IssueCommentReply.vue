  ...
  <div class="text-sm">
    <div class="flex items-center gap-x-2 mb-2">
      ...
      <MoreDropdown class="ms-auto">
        <DropdownMenuItem v-if="!readonly && comment_box.comment.member.user_id == user.id && allow('update', Comment)" @click.prevent="emit('modal', IssueCommentEditDialogContent, issue_box, comment_box)">修改</DropdownMenuItem>
