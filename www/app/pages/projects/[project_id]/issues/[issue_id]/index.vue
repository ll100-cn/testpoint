<template>
  <PageHeader>
    ...
    <div class="flex ms-auto space-x-3 items-center">
      <Button v-if="!readonly && allow('update', Issue)" :to="ok_url.apply(`${path_info.resource}/edit`)">修改</Button>
      <Button variant="destructive" v-if="!readonly && allow('manage', Issue)" :to="ok_url.apply(`${path_info.resource}/merge`)">合并</Button>
    </div>
  </PageHeader>
      ...
      <Card v-if="!readonly">
        ...
        <CardContent>
          ...
          <div class="flex items-center gap-x-2">
            ...
            <template v-if="allow('manage', Issue) || issue_box.issue.assignee_id == profile.member_id">
            ...
            <template v-if="allow('manage', Issue) || issue_box.issue.creator_id == profile.member_id">
