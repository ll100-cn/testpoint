...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_input_only, tag: false do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_input_only, tag: false do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :horizontal_boolean,
    ...
    b.wrapper :grid_wrapper, tag: 'div', class: '' do |wr|
  ...
  config.wrappers :horizontal_collection_inline,
                  ...
                  custom_collection_label_block: ->(builder) { builder.label(class: "form-check-label") } do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper :legend_tag, tag: 'legend', class: 'col-form-label pt-0' do |ba|
      ba.use :label_text
  ...
  config.wrappers :inline_form, tag: 'div', class: "d-flex", error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :minlength
  ...
  config.wrappers :inline_boolean,
                  tag: 'div',
                  class: 'form-check flex-wrap justify-content-start',
                  error_class: 'form-group-invalid',
                  valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
  ...
  config.wrappers :floating_labels_select, tag: 'div', class: 'form-label-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    b.use :html5
    b.optional :readonly
    b.use :input, class: 'custom-select custom-select-lg', error_class: 'is-invalid', valid_class: nil
    b.use :label, class: 'form-control-label'
    b.use :full_error, wrap_with: { tag: 'div', class: 'invalid-feedback' }
    b.use :hint, wrap_with: { tag: 'small', class: 'form-text text-muted' }
  end
